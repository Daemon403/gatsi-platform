...
export function TeamPage() {
  ...
  const clockToggle = async (member: User) => {
    await runMemberAction(member.id, { type: 'CLOCK_TOGGLE', userId: member.id, clockedIn: !Boolean(member.clockedIn), occurredAt: new Date().toISOString() }, 'Attendance could not be updated.');
  };
