...
export function PickupRequestScreen() {
  ...
  const submit = () => {
    if (!customer || !address.trim() || !date || !openBranches.some((branch) => branch.id === branchId)) return Alert.alert('Details needed', 'Enter the pickup details and choose an open branch.');
